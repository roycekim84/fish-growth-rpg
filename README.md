# Fish Growth RPG Prototype

Flutter와 Flame으로 제작하는 모바일 세로형 2D 픽셀아트 물고기 성장/사냥 게임이다.
...
현재 단계는 `M8 — 픽셀아트 완성 및 폴리시` 진행 중이다. 물고기 애니메이션, 해저 배경, 픽셀 UI, 전투 이펙트와 사운드·햅틱을 완료했으며 다음 체크포인트는 기기별 크기·성능 최종 조정이다.
